...
keyword = "train2014"
root_dir = os.path.join("/data/zhangcc/data/deepfashion2", keyword)
coco_annotation_path = "/data/zhangcc/data/deepfashion2/annotations"
num_images = len(glob.glob(os.path.join(root_dir, 'image', '*.jpg')))

sub_index = 0 # the index of ground truth instance
for num in range(1,num_images+1):
    json_name = os.path.join(root_dir, 'annos', str(num).zfill(6)+'.json')
    image_name = os.path.join(root_dir, 'image', str(num).zfill(6)+'.jpg')
...
json_name = os.path.join(coco_annotation_path, keyword + '.json')
