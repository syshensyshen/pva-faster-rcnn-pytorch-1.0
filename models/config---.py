...
__C.MODEL = edict()
__C.MODEL.RCNN_CIN = 512 #vertical_defect
__C.MODEL.RPN_CIN = 512 #vertical_defect
__C.MODEL.RCNN_LAST = 512 #vertical_defect
__C.MODEL.BACKBONE = 'shortlitehyper' #'shortlitehyper'
__C.MODEL.DOUT_BASE_MODEL = 336 #1792 #176 #336 #544 vertical_defect
#
# Training options
#
__C.TRAIN = edict()
...
__C.TRAIN.MIN_SCALE = 128
__C.TRAIN.MAX_SCALE = 288
...
# Max pixel size of the longest side of a scaled input image
__C.TEST.MAX_SIZE = 6400
__C.TEST.TEST_SCALE = 160
...
__C.ANCHOR_SCALES = [1.2, 2.5, 6, 10, 14, 20, 40] #vertical_defect
#__C.ANCHOR_SCALES = [1.1, 2.4, 5, 16, 32, 64, 128]

# Anchor ratios for RPN
#__C.ANCHOR_RATIOS = [0.5,1,2]
__C.ANCHOR_RATIOS = [0.333, 0.5, 0.667, 1, 1.5, 2, 3] #vertical_defect
